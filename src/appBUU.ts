...
export default class MarbleRun {
  ...
  // private resetLayer: MRE.CollisionLayer;
    ...
    // });
		...
		// 	 this.text.text.contents = "FunkyBall trigger Enter";
		...
		// 	this.text.text.contents = "FunkyBall trigger Exit";
		// 	this.kitItemBall1.transform.local.position.x=45;
		// 	this.kitItemBall1.transform.local.position.y=40;
		// 	this.kitItemBall1.transform.local.position.z=21;
		// });
		//  // });
